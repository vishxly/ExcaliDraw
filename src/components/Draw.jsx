  ...
  return (
    <>
      <div className="relative w-full h-screen overflow-hidden">
        {/* Sidebar */}
        <div
          className={`absolute top-0 z-10  py-2 ${
            sidebarOpen ? "" : "-ml-16"
          } transition-all duration-300 ease-in-out`}
        >
          <div className="flex flex-col justify-start items-center gap-3 py-2 px-3 mx-auto border shadow-lg rounded-lg ml-20 cursor-pointer">
            <div
              className="mt-4 hover:bg-violet-100 cursor-pointer"
              onClick={handleSidebarClick}
              onDoubleClick={() => setSidebarOpen(false)}
            >
              <BsLayoutTextSidebar size={50} />
            </div>
            {sidebarOpen && (
              <>
                <div
        ...
        {/* Controls */}
        <div
          className={`absolute top-0 z-10 w-full py-2 ${
